 ...
 * Share-token gated; supports HTTP Range for progressive playback.
 * P0-4: withPublicRoute for rate limit + JSON errors on failure paths.
 */
export async function GET(
  ...
  return withPublicRoute(
    ...
    { rateLimitKey: 'video.public_media', rateLimit: RATE_LIMITS.default }
  );
}
