-- Sophia Personal Tailoring — per-dealership department customizations + version history (v4.1.0)
-- Prisma twin: prisma/migrations/20250721210000_department_customization
